...
contract RebaseTokenTest is Test {
    ...
    function addRewardsToVault(uint256 amount) public {
        ...
        require(success, "addRewardsToVault: transfer failed");
    ...
    function testDepositLinear(uint256 amount) public {
        // Deposit funds
        // vm.assume(amount > 1e5);  // Only test when amount > 100,000
    ...
    function testRedeemAfterTimeHasPassed(
        ...
        uint256 balance_after = rebaseToken.balanceOf(user);
    ...
    function testDeposit(uint256 amount) public {
        ...
        uint256 userBalance_start = rebaseToken.balanceOf(user);
        assertEq(userBalance_start, 0);
    ...
    function testTransfer(uint256 amount, uint256 amountToSend) public {
        ...
        //guaranteed gap of at least 1e3 between the two values
        ...
        vm.prank(user);
        require(rebaseToken.transfer(userTwo, amountToSend), "transfer failed");
