...
contract TokenAndPoolDeployer is Script {
    function run() public returns (RebaseToken token, RebaseTokenPool pool) {
        ...
        //CCIPLocalSimulatorFork returned valid network details based on chainid
        ...
        // This grants the pool permission to mint and burn tokens on the token contract.
...
// both pool and vault will have the mint and burn role on the RebaseToken.
